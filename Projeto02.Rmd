...
# Testando a funcao de normalizaÃ§Ã£o - os resultados devem ser identicos
...
# A tabela cruzada mostra 4 possÃ­veis valores, que representam os falso/verdadeiro positivo e negativo
# A primeira coluna lista os labels originais nos dados observados
# As duas colunas do modelo (Benigno e Maligno) do modelo, mostram os resultados da previsÃ£o
# Temos:
# CenÃ¡rio 1: CÃ©lula Benigno (label) x Benigno (Modelo) - 61 casos - true negative 
# CenÃ¡rio 2: CÃ©lula Benigno (label) x Maligno (Modelo) - 00 casos - false positive 
# CenÃ¡rio 3: CÃ©lula Maligno (label) x Benigno (Modelo) - 02 casos - false negative (o modelo errou)
# CenÃ¡rio 4: CÃ©lula Maligno (label) x Maligno (Modelo) - 37 casos - true positive 

# Lendo a Confusion Matrix (Perspectva de ter ou nÃ£o a doenÃ§a):

# True Negative  = nosso modelo previu que a pessoa NÃƒO tinha a doenÃ§a e os dados mostraram que realmente a pessoa NÃƒO tinha a doenÃ§a
# False Positive = nosso modelo previu que a pessoa tinha a doenÃ§a e os dados mostraram que NÃƒO, a pessoa tinha a doenÃ§a
# False Negative = nosso modelo previu que a pessoa NÃƒO tinha a doenÃ§a e os dados mostraram que SIM, a pessoa tinha a doenÃ§a
# True Positive = nosso modelo previu que a pessoa tinha a doenÃ§a e os dados mostraram que SIM, a pessoa tinha a doenÃ§a
...
# Usando a funÃ§Ã£o scale() para padronizar o z-score 
dados_z <- as.data.frame(scale(dados[-1]))

# Confirmando transformaÃ§Ã£o realizada com sucesso
