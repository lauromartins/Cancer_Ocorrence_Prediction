...
# Independentemente do método de aprendizagem de máquina, deve sempre ser excluidas 
...
table(dados$diagnosis) #retorna a qtd de instacias em cada categoria na coluna diagnosis
...
# O cálculo de distância feito pelo kNN � dependente das medidas de escala nos dados de entrada.
...
# Carregando o pacote para classificacao
...
# Na medida que aumentamos k, diminuímos a taxa de erro do modelo
